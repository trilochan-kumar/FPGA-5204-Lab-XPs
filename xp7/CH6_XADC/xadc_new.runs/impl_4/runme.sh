...
HD_PWD='D:/project_codes/madesh_backup/EDGE_ZYNQ_7010_CODES/PL_EXAMPLES/CH6_XADC_WIFI/xadc_new.runs/impl_4'
cd "$HD_PWD"
...
EAStep vivado -log sensor_out.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sensor_out.tcl -notrace
