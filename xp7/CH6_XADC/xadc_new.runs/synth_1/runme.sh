...
HD_PWD='D:/backup_files/edge_zynq_codes/EDGE_ZYNQ_7010_CODES1/EDGE_ZYNQ_7010_CODES/XADC_WIFI/xadc_new.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sensor_out.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sensor_out.tcl
